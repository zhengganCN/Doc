...
namespace Blog.Commons.EncryptDecrypt
{
    ...
    /// RSA加密/解密
    /// </summary>
    public class RSAEncryptDecrypt : AbstractEncryptDecrypt<RSAEncryptDecrypt>
    {
        private readonly ILogger<RSAEncryptDecrypt> _logger;

        public RSAEncryptDecrypt(ILogger<RSAEncryptDecrypt> logger)
        {
            _logger = logger;
        }
